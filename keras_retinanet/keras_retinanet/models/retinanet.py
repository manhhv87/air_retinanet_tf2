...
def retinanet(
    ...
    Args
        ...
        num_pyramid_levels      : pyramid levels to use.
    ...
    features = create_pyramid_features(C3, C4, C5)[:num_pyramid_levels]
...
def retinanet_bbox(
    ...
    **kwargs
    ...
    if model is None:
        model = retinanet(num_pyramid_levels=len(anchor_params.sizes),
    ...
    # compute the anchors
    features = [model.get_layer(p_name).output for p_name in ['P3', 'P4', 'P5', 'P6', 'P7'][:len(anchor_params.sizes)]]
